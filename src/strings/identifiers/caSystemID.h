...
{ 0x0004, 0x0004, "OMA DRM Content Format – MPEG-2 TS Profile: MDCF - see OMA-TS-SCE_MDCF-V1_0" },
...
{ 0x0009, 0x00FF, "reserved for future use by standardized systems" },
...
{ 0x1EA0, 0x1EA0, "Protac" },
{ 0x1EB0, 0x1EB0, "TELECAST TECHNOLOGY CO., LTD." },
{ 0x1EC0, 0x1EC0, "Cryptoguard AB" },
{ 0x1ED0, 0x1ED1, "MM Comunicaciones S.A." },
...
{ 0x2719, 0x2719, "S-Curious Research and Technology Private Limited" },
{ 0x27A0, 0x27A4, "ByDesign India Private Limited" },
...
{ 0x4825, 0x4825, "ChinaEPG (Beijing) Technology Co., Ltd." },
...
{ 0x4B24, 0x4B24, "Prowill AB" },
{ 0x4B25, 0x4B25, "SURESOFT SYSTEMS PVT LTD" },
{ 0x4B26, 0x4B26, "Unitend Technologies, Inc." },
{ 0x4B30, 0x4B30, "Vietnam Multimedia Corporation (VTC)" },
{ 0x4B31, 0x4B31, "Vietnam Multimedia Corporation (VTC)" },
{ 0x4B3A, 0x4B3A, "ipanel" },
{ 0x4B3B, 0x4B3B, "Jinggangshan Electric Co., Ltd" },
{ 0x4B40, 0x4B41, "EXCAF TELECOM" },
{ 0x4B42, 0x4B43, "CI Plus LLP" },
...
{ 0x56A0, 0x56A0, "laxmi remote india private limited" },
{ 0x7BE0, 0x7BE1, "OOO" },
