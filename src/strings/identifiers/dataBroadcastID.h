...
{ 0x000C, 0x000C, "DVB Synchronized Auxiliary Data" },
{ 0x000D, 0x00EF, "Reserved for future use by DVB" },
{ 0x00F0, 0x00F0, "MHP Object Carousel" },
{ 0x00F1, 0x00F1, "reserved for MHP Multi Protocol Encapsulation" },
{ 0x00F2, 0x00FF, "Reserved for MHP use" },
...
{ 0x010B, 0x010B, "NDS France Technologies system software download" },
{ 0x010C, 0x010C, "GUIDE Plus+" },
...
{ 0x0123, 0x0123, "HBBTV Carousel" },
{ 0x0124, 0x0124, "Premium Content from Rovi" },
{ 0x0125, 0x0125, "Media Guide from Rovi" },
{ 0x0126, 0x0126, "InView Technology Ltd" },
{ 0x0130, 0x0130, "BOTECH ELEKTRONIK SAN. ve TIC. LTD.STI." },
{ 0x0131, 0x0131, "Scilla Push-VOD Carousel" },
{ 0x0140, 0x0140, "CANAL+" },
{ 0x0150, 0x0150, "OIPF Object Carousel" },
{ 0x0160, 0x0160, "Samsung Electronics (UK) Limited" },
{ 0x0170, 0x0170, "Digital TV Group" },
{ 0x0180, 0x0181, "South African Broadcasting Corporation" },
{ 0x0190, 0x0190, "TRICOM" },
